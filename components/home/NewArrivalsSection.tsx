...
function NewArrivalCard({ product }: { product: ProductItem }) {
  return (
    <Link
...
export function NewArrivalsSection({ products }: { products: ProductItem[] }) {
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-sm leading-relaxed text-rc-muted md:text-[15px]">
            Discover our latest handwoven masterpieces, fresh from the loom and
